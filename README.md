...
The source code (found in the `/src/` folder)  to is licensed under AGPL-3.0-or-later.

Any libraries included as part of this project (found in `/libs/` folder) are included with licences intact.
